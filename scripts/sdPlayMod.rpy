label sdSplash:
    ...
    if not persistent.lan_chosen:
        ...
        python:
            ui.imagebutton("images/misc/russian_ground.png", "images/misc/russian_hover.png", clicked = ui.returns("None"), align = (0.5, 0.4))
            
            ui.imagebutton("images/misc/english_ground.png", "images/misc/english_hover.png", clicked = ui.returns("english"), align = (0.5, 0.6))
    ...
    if not persistent.licensed:
        ...
        if _preferences.language == None:
            ...
            menu:
                ...
                "%(lic_tabY2)s{u}Yes, I accept these terms and conditions.{/u}\n":
                    pass
                "%(lic_tabN)s{u}No, I reject these terms and conditions.{/u}":
                    $ renpy.quit()
